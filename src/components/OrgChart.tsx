...
export function OrgChart() {
  ...
  return (
    <div className="flex flex-col items-center">
      <div className="rounded-xl border-2 border-navy bg-white px-8 py-3 text-center">
        <p className="text-xs text-ink-soft">{director.role}</p>
        <p className="text-lg font-bold text-navy">{director.name}</p>
      </div>
      <div className="h-4 w-px bg-line" />
      <div className="rounded-lg border border-line bg-white px-5 py-2 text-center text-sm">
