        ...
        <article className="card space-y-5 text-sm leading-relaxed md:text-[15px] [&_h2]:mb-1.5 [&_h2]:text-base md:[&_h2]:text-lg [&_h2]:font-bold [&_h2]:text-navy [&_li]:ml-5 [&_li]:list-disc">
          ...
          <section>
            ...
            <ul>
              ...
              <li>
                조직도 게시: 최상위 관리자가 게시를 확인한 운영진과 반별 학부모 대표·부대표의 이름과 역할을 홈페이지 &lsquo;합창단
                소개&rsquo; 조직도에 게시 (연락처·이메일 제외, 요청 시 즉시 게시 중단)
              </li>
              ...
              <li>
                단원 소개: 홈페이지 &lsquo;단원 소개&rsquo; 화면에 활동 중인 단원의 이름과 반을 게시 (입단 신청 때 보호자의 선택
          ...
          <section>
            ...
            <ul>
              ...
              <li>
                회원가입(합창단 운영진, 필수): 이름, 연락처, 이메일, 비밀번호(암호화 저장), 운영진 역할 / (선택): 세부 담당, 관리자
                권한 신청 사유
              </li>
              <li>
                입단 신청(단원, 필수): 이름, 생년월일, 성별, 소속 기관(학교·유치원), 원하는 반, 사는 동, 가입경로 / (선택):
                소개해 준 사람, 특이사항, 단원 소개 이름·반 게시 동의 여부
              </li>
              <li>
            ...
            <ul>
              ...
              <li>
                ...
                <ul className="mt-1">
                  ...
                  <li>신청일부터 6개월이 지나도록 심사하지 않은 경우: 6개월이 지나면 파기</li>
                  <li>
                  ...
                  <li>
                    승인된 경우: 단원 활동 종료(퇴단) 후 1년. 승인 후 3개월 안에 단원 명부에 등록되지 않으면(입단하지 않은 경우) 그때
                    파기하며, 단원 명부에서 삭제하면 입단 신청 정보도 함께 파기
                  </li>
                </ul>
              </li>
              <li>
              ...
              <table className="w-full min-w-[720px] border-collapse text-sm [&_td]:border [&_td]:border-line [&_td]:p-2 [&_td]:align-top [&_th]:border [&_th]:border-line [&_th]:bg-cream [&_th]:p-2 [&_th]:text-left">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      보호자·운영진: 이름, 연락처, 이메일, 비밀번호(암호화), 운영진 역할·세부 담당 / 단원: 이름, 생년월일, 성별, 소속 기관, 원하는 반, 사는
